        ...
        <div className="contact-info glass-card">
          ...
          <div className="contact-details">
            <div className="contact-item">
              ...
              <div className="contact-text">
                <h4>Email</h4>
                <a href="mailto:phanikumarpotharlanka999@gmail.com">phanikumarpotharlanka999@gmail.com</a>
              </div>
            </div>
            <div className="contact-item">
              <div className="contact-icon">📞</div>
              <div className="contact-text">
                <h4>Phone</h4>
                <a href="tel:+919133760528">+91 9133760528</a>
              </div>
            </div>
          </div>
          ...
          <div className="social-links">
            ...
            <div className="social-icons">
              <a
                href="https://www.linkedin.com/in/phani-kumar-potharlanka-9433b5321/"
                target="_blank"
              ...
              <a
                href="https://github.com/Phanikumar9133"
                target="_blank"
                rel="noopener noreferrer"
                className="social-link"
              >
